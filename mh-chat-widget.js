(function () {
  ...
  function startEksternChat(inputDefaults) {
    function run() {
      ...
      zissonWebChat.setDefaults(inputDefaults);
      zissonWebChat.openWidget?.();
      zissonWebChat.startConversation?.();
    }
  ...
  [county, gender, age].forEach((el) => el.addEventListener("change", update));
